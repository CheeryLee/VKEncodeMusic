...
public class SongWidgetNonRoot extends ArrayAdapter<String> {
	private Context context;
	private String values[];
	static int donePositions[];
	
	public SongWidgetNonRoot(Context _context, String _values[]) {
		super(_context, R.layout.song_widget_nonroot, _values);
		context = _context;
		values = _values;	
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View rowView = inflater.inflate(R.layout.song_widget_nonroot, parent, false);
		
		final TextView filename_text = (TextView)rowView.findViewById(R.id.songName_nonroot);
		final ImageButton button = (ImageButton)rowView.findViewById(R.id.downloadButton_nonroot);
		...
		button.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				String encodedName = MusicActivity.encodedPath + filename_text.getText().toString() + ".encoded";
